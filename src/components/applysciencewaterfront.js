...
<div className='back64'>
   ...
   <div className='hashh64w'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Seller</div>
     ...
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/carappwaterfront'>Buyer</a>
      <Popup trigger={<a id='mortgagecalcreact' className='innerelementwater642' style={{zIndex: '7', position: 'absolute', left: '45px', top: '425px' }} href="#DKre">Mortgage Calculator</a>}

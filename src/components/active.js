...
/////// if else conditionals <button> <img> ///////////// #id
.map((item, index) => (
...
function alert(){
  alert('you are Batman to infinity');
}
...
<div className='background64'>
   ...
   position='center' modal nested>
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activemultifamily">Suburb</a>
     <div>
          <ul>
...
{close => (
 ...
 <div id='noplacelikehome' className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '12px', top: '1171px' }}></div>     
<div id='toto' className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '1067px', top: '1171px' }}></div>

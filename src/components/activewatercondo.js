...
{close => (
    ...
    <div id='noplacelikehome' className='listpricediv64' style={{zIndex: '7', position: 'absolute', left: '12px', top: '1171px' }}></div>
    <div id='toto' className='listpricediv64' style={{zIndex: '7', position: 'absolute', left: '1067px', top: '1171px' }}></div> 

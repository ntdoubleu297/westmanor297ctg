...
<div className='background'>
  ...
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
     ...
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '15px', top: '676px', width: '520px', height: '365px', borderRadius: '10%', background: 'rgb(120, 120, 120)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '555px', top: '641px', width: '396px', height: '447px', borderRadius: '10%', background: 'rgb(120, 120, 120)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '972px', top: '652px', width: '300px', height: '438px', borderRadius: '10%', background: 'rgb(120, 120, 120)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData13}
                    ...
                    <Popup trigger={<a id ='onebed' title={belowdiffratesPlanAavgbed} href='#/onebed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '695px' }} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData14}
                 ...
                 <Popup trigger={<a id ='twobed' title={belowdiffratesPlanBavgbed} href='#/twobed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '784px' }}></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData15}
                 ...
                 <Popup trigger={ <a  id='threebed' title={belowdiffratesPlanCavgbed} href='#/threebed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '860px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData16}
                 ...
                 <Popup trigger={<a id ='fourbed' title={belowdiffratesPlanDavgbed} href='#/fourbed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '935px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData17}
                 ...
                 <Popup trigger={<a id ='fivebed' title={belowdiffratesPlanEavgbed} href='#/fivebed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '1010px'}} ></a>}
    position='center' modal nested>
{close => (
     ...
     <Popup
trigger={<div id='noplacelikehome' className='listpricediv64' style={{zIndex: '7', position: 'absolute', left: '12px', top: '1171px' }}></div>}
position="center"
modal
nested       
>
...
<div className='borders'>
 ...
 <td ref={(_subtitle) => (subtitle = _subtitle)}>Days On Market: {julius.DOM}</td><br/>
    ...
    <Popup
trigger={<div id='toto' className='listpricediv64' style={{zIndex: '7', position: 'absolute', left: '1067px', top: '1171px' }}></div>}
position="center"
modal
nested       
>

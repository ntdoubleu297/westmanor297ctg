  ...
  //if (data.status ==='ok'){
    ...
    for (let i = 0; i<data.length; i++){
      if (data[i].county ===`${county3}` && data[i].townstate === `${town2}` && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" ){
        ...
        /////// greater than or equal to arrays below...
...
<div className='innerelementback'>
  ...
  <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='#'>Buyer/Seller</a>
  </div>
...
<a id ='threebears' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '670px' }}></a>
...
<a id ='threebears21' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '215px', top: '670px' }}></a>
...
<br/>
<br/>
<select id='value' style={{zIndex: '7', position: 'absolute', left: '990px', top: '725px' }} value={county} onChange={(e)=> setCounty(e.target.value)}> 
...
return (
  <option value={index}>
    ...
    <select id='datetopvalue' style={{zIndex: '7', position: 'absolute', left: '990px', top: '775px' }} value={datetop} onChange={(e)=> setDatetop(e.target.value)}> 
...
return (
  <option value={index}>
    ...
    <select id='datetopvalue' style={{zIndex: '7', position: 'absolute', left: '990px', top: '750px' }} value={towntop} onChange={(e)=> setTowntop(e.target.value)}> 
    <option>---Choose Your Town---</option>
...
return (
  ...
  <br/>
      ...
      <br/>
      <br/>
      <select id='pricerangevalue' style={{zIndex: '7', position: 'absolute', left: '275px', top: '1335px' }} value={pricerangetown1} onChange={(e)=> setPricerangetown1(e.target.value)}> 
    <option>---Choose Your Town---</option>
    {barnstabletowns.map((index) => {
return (
  <option value={index}>
    {index}
      ...
      <select id='pricerangevalue' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1335px' }} value={pricerangecounty1} onChange={(e)=> setPricerangecounty1(e.target.value)}> 
    <option>---Choose Your County---</option>
    {MAcounty.map((index) => {
return (
  <option value={index}>
...
<a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '1550px' }}>0-14 days</a>
  ...
  <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '725px', top: '930px'}}>REPEAT via days on market IE [1/1/2021-12/31/2021]</h5>
      ...
      <a></a>
      <div id='r14' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1000px' }}></div>
      <a></a>
      ...
      <a></a>
      <div id='s30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1075px' }}></div>
      <a></a>
      <div id='fr30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1075px' }}></div>
      <a></a>
      <div id='r30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1075px' }}></div>
      <a></a>
      <div id='d30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1075px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1150px' }}>31-45 days</a>
      <a></a>
      <div id='s45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></div>
      <a></a>
      <div id='fr45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1150px' }}></div>
      <a></a>
      <div id='r45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></div>
      <a></a>
      <div id='d45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1150px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1225px' }}>46-90 days</a>
      <a></a>
      <div id='s90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1225px' }}></div>
      <a></a>
      <div id='fr90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1225px' }}></div>
      <a></a>
      <div id='r90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1225px' }}></div>
      <a></a>
      <div id='d90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1225px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1300px' }}>91-120 days</a>
      <a></a>
      <div id='s120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></div>
      <a></a>
      <div id='fr120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1300px' }}></div>
      <a></a>
      <div id='r120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></div>
      <a></a>
      <div id='d120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1300px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1375px' }}>121+ days</a>
      <a></a>
      <div id='s121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1375px' }}></div>
      <a></a>
      <div id='fr121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1375px' }}></div>
      <a></a>
      <div id='r121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1375px' }}></div>
      <a></a>
      <div id='d121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1375px' }}></div>
      <br/>
  <br/>
  ...
  <div style={{zIndex: '7', position: 'absolute', left: '100px', top: '1400px' }}>----------------------------------------------</div>
    <br/>
    <br/>
    <select id='applysciencevalue' style={{zIndex: '7', position: 'absolute', left: '900px', top: '1450px' }} value={county3} onChange={(e)=> setCounty3(e.target.value)}> 
    <option>---Choose Your County---</option>
    {MAcounty.map((index) => {
return (
  <option value={index}>
    ...
    <select id='applysciencevalue2' style={{zIndex: '7', position: 'absolute', left: '900px', top: '1470px' }} value={town2} onChange={(e)=> setTown2(e.target.value)}> 
    <option>---Choose Your Town---</option>
    {barnstabletowns.map((index) => {
return (
  <option value={index}>
  ...
  <Button style={{zIndex: '7', position: 'absolute', left: '700px', top: '1500px'}} variant='dark' type="button" value='Submit' onClick={populateQuote}>Apply Science</Button>
  <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1575px' }}>0-14 days</a>
      ...
      <a></a>
      <div id='rates14' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1575px' }}></div>
      <a></a>
      ...
      <a></a>
      <div id='sales30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1650px' }}></div>
      <a></a>
      <div id='fraction30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1650px' }}></div>
      <a></a>
      <div id='rates30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1650px' }}></div>
      <a></a>
      <div id='duff30' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1650px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1725px' }}>31-45 days</a>
      <a></a>
      <div id='sales45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></div>
      <a></a>
      <div id='fraction45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1725px' }}></div>
      
      <a></a>
      <div id='rates45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></div>
      <a></a>
      <div id='duff45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1725px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1800px' }}>46-90 days</a>
      <a></a>
      <div id='sales90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1800px' }}></div>
      <a></a>
      <div id='fraction90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1800px' }}></div>
      <a></a>
      <div id='rates90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1800px' }}></div>
      <a></a>
      <div id='duff90' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1800px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1875px' }}>91-120 days</a>
      <a></a>
      <div id='sales120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></div>
      <a></a>
      <div id='fraction120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1875px' }}></div>
      <a></a>
      <div id='rates120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></div>
      <a></a>
      <div id='duff120' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1875px' }}></div>
      <br/>
      <br/>
      <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1950px' }}>121+ days</a>
      <a></a>
      <div id='sales121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1950px' }}></div>
      <a></a>
      <div id='fraction121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1950px' }}></div>
      <a></a>
      <div id='rates121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1950px' }}></div>
      <a></a>
      <div id='duff121' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1950px' }}></div>
      <br/>
      <br/> 
      <select id='value' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2025px' }} value={town} onChange={(e)=> setTown(e.target.value)}> 
...
return (
  <option value={index}>
    ...
    <select id='countyplan' style={{zIndex: '7', position: 'absolute', left: '250px', top: '2500px' }} value={county} onChange={(e)=> setCounty2(e.target.value)}> 
    <option>---Choose Your County---</option>
    {MAcounty.map((index) => {
return (
  <option value={index}>
    ...
    <Button style={{zIndex: '7', position: 'absolute', left: '400px', top: '2550px' }}variant='dark' type="button" value='Submit' onClick={()=> {businessplanning(); businessplanning21(); businessplanning20(); marketflush21();}}>Click Me</Button>
    ...
    <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
      ...
      <a></a>
      <div id='planArate' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2830px' }}></div>
      ...
      <a></a>
      <div  id='planArate21' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2880px' }}></div>
      ...
      <a></a>
      <div id='planArate20' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2930px' }}></div>
      ...
      <a></a>
      <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '325px', top: '2990px' }}>$4.3/4.6</div>
      <a></a>
      ...
      <a></a>
      <div id='planBrate' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2830px' }}></div>
      ...
      <a></a>
      <div id='planBrate21' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2880px' }}></div>
      ...
      <a></a>
      <div id='planBrate20' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2930px' }}></div>
      ...
      <a></a>
      <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '2990px' }}>$x.x/x.x</div>
      <a></a>
      ...
      <a></a>
      <div id='planCrate' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3175px' }}></div>
      ...
      <a></a>
      <div id='planCrate21' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3225px' }}></div>
      ...
      <a></a>
      <div id='planCrate20' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3275px' }}></div>
      ...
      <a></a>
      <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3340px' }}>$x.x/x.x</div>
      <a></a>
      ...
      <a></a>
      <div id='planDrate' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3175px' }}></div>
      ...
      <a></a>
      <div id='planDrate21' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3225px' }}></div>
      ...
      <a></a>
      <div id='planDrate20' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3275px' }}></div>
      ...
      <a></a>
      <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '920px', top: '3340px' }}>$x.x/x.x</div>
      <a></a>
      <div id='avgDrate' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3340px' }}></div>
      <div id='avgDdiff' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1040px', top: '3340px' }}></div>
      <br/>
      <br/>
      <br/>
      ...
      <a></a>
      <div id='planErate' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3515px' }}></div>
      ...
      <a></a>
      <div id='planErate21' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3565px' }}></div>
      ...
      <a></a>
      <div id='planErate20' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3615px' }}></div>
      ...
      <a></a>
      <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3675px' }}>$x.x/x.x</div>
      <a></a>
      ...
      <br/>
  <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '880px', top: '3450px'}}>[120days 2021 bp]</h5>
  <br/>
      ...
      <a></a>
      <div id='rates14flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3510px' }}></div>
      <a></a>
      <div id='duff14flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3510px' }}></div>
      <br/>
      <br/>
      ...
      <a></a>
      <div id='rates30flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3560px' }}></div>
      <a></a>
      <div id='duff30flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3560px' }}></div>
      <br/>
      <br/>
      ...
      <a></a>
      <div id='rates45flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3610px' }}></div>
      <a></a>
      <div id='duff45flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3610px' }}></div>
      <br/>
      <br/>
      ...
      <a></a>
      <div id='rates90flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3660px' }}></div>
      <a></a>
      <div id='duff90flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3660px' }}></div>
      <br/>
      <br/>
      ...
      <a></a>
      <div id='rates120flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3710px' }}></div>
      <a></a>
      <div id='duff120flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3710px' }}></div>
      <br/>
      <br/>
      ...
      <a></a>
      <div id='rates121flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3760px' }}></div>
      <a></a>
      <div id='duff121flush' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3760px' }}></div>
      <br/>

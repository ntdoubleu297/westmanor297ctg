 ...
 */
  ...
  document.getElementById('geocoder').appendChild(geocoder.onAdd(map));
    ...
    for (const marker of myGeoJSONData.features) {
      ...
      const height = '30px';
      el.className = 'marker';
      el.innerHTML = `<div style={{color: rgb(130,130,130)}}>${marker.properties.listprice}</div>`
...
w
    ...
    //  new MapboxGeocoder({
     ...
     document.getElementById('DOM85abovepopulatequote').innerHTML = '85% of sales above list price sold @ ' + `${DOMTotalsalesinnerElement2}` + 'days of ' + `${TotalSalesamount2}` + ' Total Sales'; // showing 80...
      ...
      <div className='innerelementback'>
         ...
         <img style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={matheus} alt='hella' />
  ...
  <div id='map' style={{left: '218px', top: '595px', position: 'absolute' }} ref={mapContainer} className="map-container" />
             ...
             <div className="actions">
               ...
               >
                 ...
                 <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '210px', top: '1160px' }}>West Enterprises #applyscience Product Model</h5>
                      ...
                      <img style={{height: '351px', width: '1500px', position: 'absolute', top: '1635px' }} src={hottubbubblezzz} alt='pixa'/>
